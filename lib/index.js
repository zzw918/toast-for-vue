...
Toast.install = function (Vue, options) {
  ...
  // for loadingMore
  Vue.prototype.$loadingMore = function(element,type) {
      var loadMore = document.querySelector('.load-more-box');
      if(type == 'close'){
          loadMore && (loadMore.outerHTML = '');
      }else{
          if(loadMore){
              return;
          }
          var loadTpl = Vue.extend({
              template: '<div class="load-more-box"><div class="loading-more"><div class="loading_leaf loading_leaf_0"></div><div class="loading_leaf loading_leaf_1"></div><div class="loading_leaf loading_leaf_2"></div><div class="loading_leaf loading_leaf_3"></div><div class="loading_leaf loading_leaf_4"></div><div class="loading_leaf loading_leaf_5"></div><div class="loading_leaf loading_leaf_6"></div><div class="loading_leaf loading_leaf_7"></div><div class="loading_leaf loading_leaf_8"></div><div class="loading_leaf loading_leaf_9"></div><div class="loading_leaf loading_leaf_10"></div><div class="loading_leaf loading_leaf_11"></div></div></div>'
          });
          var tpl = new loadTpl().$mount().$el;
  ...
  ['open', 'close'].forEach(function(type) {
      Vue.prototype.$loadingMore[type] = function(element) {
          return Vue.prototype.$loadingMore(element,type)
      }
  });
}
